...
export default function Marks({ mycourses, StudentId }) {
    ...
    const fetchquizmarks = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/quizzes/quizmarks/${StudentId}/${selectedCourseId}`
        );
  ...
  useEffect(() => {
    const fetchassignmentmarks = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/assignments/assignmentmarks/${StudentId}/${selectedCourseId}`
        );
  ...
  useEffect(() => {
    const fetchmidmarks = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/mids/midmarks/${StudentId}/${selectedCourseId}`
        );
  ...
  useEffect(() => {
    const fetchfinalmarks = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/finals/finalmarks/${StudentId}/${selectedCourseId}`
        );
