...
export default async function StudentTranscriptPage({ params }) {
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_API_URL}/transcript/gettranscript/${StudentId}`,
    { next: { revalidate: 0 } }
  );
      ...
      <div className="flex-1 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-bold text-gray-700">Transcript</h1>
            <p className="text-gray-500 mt-1">Academic performance summary</p>
          </div>
